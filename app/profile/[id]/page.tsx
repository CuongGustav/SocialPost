...
const ProfilePageDetail = () => {
    const { id } = useParams(); // Get user_id from dynamic route
    ...
    return (
        <div className="flex w-7/10 mx-auto gap-4 mt-8">
            <div className="w-7/10 flex flex-col rounded-[25px] border border-gray-300 pb-8 justify-center mx-auto sticky top-12">
