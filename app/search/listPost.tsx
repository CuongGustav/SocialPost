    ...
    <div className="flex flex-col">
      {posts.map((post) => (
        <div
          ...
          onClick={() => router.push(`/post/${post.id}`)} // Điều hướng đến trang chi tiết
        >
          ...
          <div className="ml-2 mt-2 w-full">
            <div className="flex flex-row gap-2">
              <div className="font-bold overflow-hidden cursor-pointer hover:underline">{post.username}</div>
              <div>
